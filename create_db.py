...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'stsabath', 'email': 'stsabath@terpmail.umd.edu', 'first_name':'Sebestyen', 'last_name':'Toszegi-Sabath',
            'password': generate_password_hash('stsabath', method='pbkdf2:sha256'), 'role':'STUDENT'},
    ]
    ...
    students = [
        ...
        {'first_name': 'Sebestyen', 'last_name': 'Toszegi-Sabath', 'email': 'stsabath@terpmail.umd.edu',
            'major_id': 2, 'birth_date': dt.strptime('2002-06-15', '%Y-%m-%d'), 'is_honors': 1},
    ]
